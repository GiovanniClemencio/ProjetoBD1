 ...
 * @author Portu
 */
public class TelaMissaoIndividual extends javax.swing.JFrame {

    private final java.awt.Frame parent;
    private final Missao missao;
    private final Runnable aoFechar;
    
    public TelaMissaoIndividual(java.awt.Frame parent, Missao missao, Runnable aoFechar) {
        this.parent = parent;
        this.missao = missao;
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (TelaMissaoIndividual.this.aoFechar != null) {
                    TelaMissaoIndividual.this.aoFechar.run();
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        textAreaMissao = new javax.swing.JTextArea();
        ...
        textAreaMissao.setColumns(20);
        textAreaMissao.setRows(5);
    ...
    private javax.swing.JTextArea textAreaMissao;
