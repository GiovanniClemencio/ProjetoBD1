 ...
 * @author Portu
 */
public class removerItemPersonagem extends javax.swing.JDialog {
    ...
    public removerItemPersonagem(java.awt.Frame parent, boolean modal, GerenciadorControladores controladores, Personagem personagem, Runnable aoFechar) {
        super(parent, modal);
        this.parent = parent;
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (removerItemPersonagem.this.aoFechar != null) {
                    removerItemPersonagem.this.aoFechar.run();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        buttonCadastrar.setText("Remover");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(comboItem, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(222, 222, 222)
        ...
        titulo.setText("Remover item do Personagem");
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        try {
            Item itemSelecionado = (Item) comboItem.getSelectedItem();
            ...
            ctrlPersonagem.personagemPerdeItem(
            ...
            JOptionPane.showMessageDialog(this,
                "Item removido do inventário com sucesso!");

            dispose();

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this,
                "Erro ao remover item do inventário: " + e.getMessage(),
                "Erro",
    ...
    private javax.swing.JComboBox<Item> comboItem;
