 ...
 * @author Portu
 */
public class edicaoPersonagem extends javax.swing.JDialog {
    ...
    public edicaoPersonagem(java.awt.Frame parent, boolean modal, Personagem personagem, GerenciadorControladores controladores, Runnable aoFechar) {
        super(parent, modal);
        this.parent = parent;
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (edicaoPersonagem.this.aoFechar != null) {
                    edicaoPersonagem.this.aoFechar.run();
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        titulo.setText("Edição de Personagem");
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        try {
            ...
            ctrlPersonagem.atualizarPersonagem(
            ...
            personagem.setCargaMaxima(cargaMaxima);
            personagem.setXp(xp);
            ...
            personagem.setIdJogador(idJogador);
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao atualizar personagem: " + e.getMessage(),
                    "Erro",
                    JOptionPane.ERROR_MESSAGE);
    ...
    private void carregarDadosDoPersonagem() {
        ...
        campoCarga.setText(String.valueOf(personagem.getCargaMaxima()));
        campoXp.setText(String.valueOf(personagem.getXp()));
        campoHp.setText(String.valueOf(personagem.getVida()));
        campoStr.setText(String.valueOf(personagem.getForca()));
        campoDex.setText(String.valueOf(personagem.getDestreza()));
        campoCon.setText(String.valueOf(personagem.getConstituicao()));
        campoInt.setText(String.valueOf(personagem.getInteligencia()));
        campoWis.setText(String.valueOf(personagem.getSabedoria()));
        campoChar.setText(String.valueOf(personagem.getCarisma()));

        selecionarJogadorDoPersonagem(personagem.getIdJogador());
    }

    private void selecionarJogadorDoPersonagem(String idJogador) {
        ...
        for (int i = 0; i < comboJogador.getItemCount(); i++) {
            Jogador jogador = comboJogador.getItemAt(i);
            if (idJogador.equals(jogador.getIdJogador())) {
