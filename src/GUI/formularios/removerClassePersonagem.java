 ...
 * @author Portu
 */
public class removerClassePersonagem extends javax.swing.JDialog {
    ...
    public removerClassePersonagem(java.awt.Frame parent, boolean modal, GerenciadorControladores controladores, Personagem personagem, Runnable aoFechar) {
        super(parent, modal);
        this.parent = parent;
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (removerClassePersonagem.this.aoFechar != null) {
                    removerClassePersonagem.this.aoFechar.run();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        titulo.setText("Remover classe do Personagem");
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        try {
            ...
            ctrlPersonagem.desvincularClasse(personagem.getIdPersonagem(), classeSelecionada.getIdClasse());
