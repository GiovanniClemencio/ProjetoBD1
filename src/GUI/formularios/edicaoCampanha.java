 ...
 * @author Portu
 */
public class edicaoCampanha extends javax.swing.JDialog {
    ...
    public edicaoCampanha(java.awt.Frame parent, boolean modal, GerenciadorControladores controladores, Campanha campanha, Runnable aoFechar) {
        super(parent, modal);
        this.parent = parent;
        ...
        configurarEventos();
        carregarDadosDaCampanha();

        addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (edicaoCampanha.this.aoFechar != null) {
                    edicaoCampanha.this.aoFechar.run();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        titulo.setText("Edição de Campanha");
    ...
    private void buttonLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLimparActionPerformed
        campoNome.setText("");
        comboMestre.setSelectedIndex(-1);
    ...
    private void atualizarEstadoBotaoCadastrar() {
        ...
        buttonCadastrar.setEnabled(nomePreenchido && mestreSelecionado);
    }

    private void carregarDadosDaCampanha() {
        campoNome.setText(campanha.getNome());
        ...
        try {
            ...
            selecionarMestreDaCampanha(campanha.getIdMestre());
    ...
    private void selecionarMestreDaCampanha(String idMestre) {
        if (idMestre == null || idMestre.isBlank()) {
            comboMestre.setSelectedIndex(-1);
            return;
        }

        for (int i = 0; i < comboMestre.getItemCount(); i++) {
            Jogador jogador = comboMestre.getItemAt(i);

            // troque getId() pelo getter real do ID na sua classe Jogador
            if (idMestre.equals(jogador.getIdJogador())) {
                comboMestre.setSelectedIndex(i);
                return;
            }
        }
