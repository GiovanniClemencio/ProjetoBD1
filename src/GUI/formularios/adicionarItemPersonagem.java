 ...
 * @author Portu
 */
public class adicionarItemPersonagem extends javax.swing.JDialog {
    ...
    public adicionarItemPersonagem(java.awt.Frame parent, boolean modal, GerenciadorControladores controladores, Personagem personagem, Runnable aoFechar) {
        super(parent, modal);
        this.parent = parent;
        ...
        addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (adicionarItemPersonagem.this.aoFechar != null) {
                    adicionarItemPersonagem.this.aoFechar.run();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        titulo.setText("Adicionar item ao Personagem");
    ...
    private void buttonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCadastrarActionPerformed
        try {
            ...
            ctrlPersonagem.personagemGanhaItem(
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao adicionar item ao inventário: " + e.getMessage(),
                    "Erro",
