...
import GUI.formularios.edicaoClasse;
 ...
 * @author Portu
 */
public class TelaClasseIndividual extends javax.swing.JFrame {
    ...
    public TelaClasseIndividual(java.awt.Frame parent, Classe classe, GerenciadorControladores controladores, Runnable aoFechar) {
        this.parent = parent;
        this.classe = classe;
        ...
        titulo.setText(classe.getNome());
        carregarConteudo();
        
        addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosed(java.awt.event.WindowEvent e) {
                if (TelaClasseIndividual.this.aoFechar != null) {
                    TelaClasseIndividual.this.aoFechar.run();
                }
            }
        });
    ...
    private void initComponents() {
        ...
        textAreaClasse = new javax.swing.JTextArea();
        ...
        textAreaClasse.setColumns(20);
        textAreaClasse.setRows(5);
        jScrollPane1.setViewportView(textAreaClasse);
    ...
    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        edicaoClasse dialog = new edicaoClasse(this, true, classe, controladores, () -> {
            new TelaClasseIndividual(this, classe, controladores, () -> {
                new TelaInicial(controladores).setVisible(true);
            });
        });
        dialog.setLocationRelativeTo(this);
    ...
    private javax.swing.JTextArea textAreaClasse;
